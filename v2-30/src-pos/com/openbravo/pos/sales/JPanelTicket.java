...
//Este metodo se llama cuando se presiona la tecla =, entre otras opciones, cTrans describe que tipo de tecla o funcion fue invocada
        if (cTrans == '\n') {
...
// Se ha presionado la tecla =, para terminar un ticket
           if (m_oTicket.getLinesCount() > 0) {
           //Se procede si el ticket realmente tiene articulo sino se muestra un pitido de que no tiene sentido terminar nada
                if(jCheckFiscalCredit.isSelected()) {
                    //Aqui verificamos si se desea imprimir una factura valida con comprobante fiscal
                    if(m_oTicket.getCustomer() == null){
                        ...
                        if(clienteRNC.equals("")) {
                            ...
                            jCheckFiscalCredit.setSelected(false);
                    ...
                    m_oTicket.hasNCF(false);
                        if (closeTicket(m_oTicket, m_oTicketExt)) {
                            // Ends edition of current receipt
                            m_ticketsbag.deleteTicket();

                            //Aqui seria talvez la mejor opcion para resetear el CheckBox
    ...
    private boolean closeTicket(TicketInfo ticket, Object ticketext) {
        ...
        if (m_App.getAppUserView().getUser().hasPermission("sales.Total")) {  
            ...
            try {
                ...
                if (ticket.getTotal()>=0.0){ //Si es major que 0 significa que es un ticket de venta, de otra manera se esta devolviendo $$
            ...
            // reset the payment info
            //Aqui podria resetear el Checkbox de credito fiscal, este o no este seleccionado ...
    ...
    private void printTicket(String sresourcename, TicketInfo ticket, Object ticketext) {
        ...
        if (sresource == null) {
            ...
            try {
                ...
                //Aqui puedo gregar objetos para ser utilizados en el Script de impresion como por ejemplo Printer.Ticket en Resources ...
                ...
                //Aqui se manda el ticket con toda la informacion para que dado el archivo
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        jCheckFiscalCredit = new javax.swing.JCheckBox();
        ...
        jCheckFiscalCredit.setText("Para credito fiscal");
        jCheckFiscalCredit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckFiscalCreditActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        m_jPanTotals.add(jCheckFiscalCredit, gridBagConstraints);
    ...
    private void jCheckFiscalCreditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckFiscalCreditActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCheckFiscalCreditActionPerformed
    ...
    private javax.swing.JCheckBox jCheckFiscalCredit;
