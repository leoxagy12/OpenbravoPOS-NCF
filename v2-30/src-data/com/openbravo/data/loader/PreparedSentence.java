...
public class PreparedSentence extends JDBCSentence {
    ...
    //Esta clase es el Parser del PreparedStatement, se inicializa con el mismo y se invocan metodos ocmo setVAR para poner
    //los valores correspondientes, sustituyendo los signos de interrogacion
...
//m_SerWrite.writeValues() es al que se le pasa al "Parser" PerparedSentencePars y los parametros para "unirlos en una
//sola sentencia SQL ... , que seria llamando los metodos de PreparedSentencepars que configuraran
            if (m_SerWrite != null) {
                // si m_SerWrite fuera null deberiamos cascar.
                m_SerWrite.writeValues(new PreparedSentencePars(m_Stmt), params);
            }

            if (m_Stmt.execute()) { // execute() devuelve TRUE si es un ResultSet y FALSE si es un UPDATE COUNT
    ...
    //pone NULL o cierra normalmente el PreparedStatement,  recordar que lo tenemos en sentence y podemos volver a crearlo ....
